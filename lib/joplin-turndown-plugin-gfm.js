var turndownPluginGfm = (function(exports) {
    ...
    rules.table = {
        ...
        replacement: function(content, node) {
            ...
            var lineCells = [];
            var allCells = [];
            var allLines = content.trim().split("\n");
            allLines.forEach((line, lineNumber) => {
                lineCells = line.split("|");
                lineCells.shift();
                //lineCells.pop();
                lineCells.forEach((cell, cellNumber) => {
            ...
            //     console.log(i + " " + j);
            //     //allCells[(i, j)].padEnd(maxWidth[j], ".");
            //   }
            // }
            allCells.forEach(function(line, index, array) {
                line.forEach(function(cell, idx, arr) {
                    //console.log(index, idx, cell);

                    allCells[index][idx] = "|" + cell.padEnd(maxWidth[idx], "  ");
                    var fixd = "";
                    ...
                    //allCells[index][idx] = cell;
                    //console.log(allCells[index][idx] + " Max width: " + maxWidth[idx]);
                    //console.log(cell);
                });
                //allCells[index][line.length - 1] += "\n";
            });
            //var mdTable = allCells.join("-");
